package GeekBrainsFinalTask.Program.View;
        ...
        while (true) {
            ...
            switch (command) {
                ...
                case READ:
                    ...
                    break;
                case TRAIN:
                    Animal animal = getAnimal("Выберете № животного для тренеровки: ");
                    animal.showCommands();
                    ...
                    break;
                case LIST_COMMANDS:
                    Animal animalC = getAnimal("Выберете № животного для просмотра изученных команд: ");
